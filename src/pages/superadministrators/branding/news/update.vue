...
export default {
    ...
    methods:{
        ...
        Cancel(){
            this.$router.push('/super-admin-news-landing')
        },
    ...
    created(){
        ...
        context.form.qFiles[0].showPreview = true;
        context.form.qFiles[0].imagePreview = context.selectedNews.fileUrl;
        context.form.qFiles[0].fileType = context.selectedNews.fileType;
