...
export default {
    ...
    data(){
        return {
            title: "Import Levels",
            appVariables: [{variableTitle: "Level Name", variableName: "type"}],
            applicationColumns: [],
            dialogs: dialogs,
            tableRows: [],
        }
    ...
    methods:{
        ...
        async createLevels(){
            var context = this;
            var user = this.$store.getters["authenticationStore/IdentityModel"]
            var Levels = context.tableRows.map((row) => {
                const newRow = {}
    ...
    created(){
        ...
        this.$store.commit("authenticationStore/setErrorMessages", "");
         this.$store.commit("authenticationStore/setPageTitle", "Import Levels");  
    }
}
</script>