const form = {
    ...
    qSelects: [],
    qInputs: [
        { label: "Story", name: "", type: "textarea",
        selectedFile: null,
        files: [],
        Template: {
            sn: 0,
...
const dialogs = [
    { title: "Create Story", isVisible: false, message: "Do you want to create a story",
    okayEvent: "okDialog", cancelEvent: "cancelDialog" },
    { title: "Success", isVisible: false, message: "Story created successfully!",
    okayEvent: "okDialog", cancelEvent: "cancelDialog" },
