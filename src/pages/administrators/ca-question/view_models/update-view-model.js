const form = {
    title: "Update Continuous Assessment Question",
    qSelects: [],
    qInputs: [
...
const dialogs = [
    { title: "Update Continuous Assessment Question", isVisible: false, message: "Do you want to update continuous assessment question",
    okayEvent: "okDialog", cancelEvent: "cancelDialog" },
    { title: "Success", isVisible: false, message: "Continuous assessment question updated successfully!",
    okayEvent: "okDialog", cancelEvent: "cancelDialog" },
