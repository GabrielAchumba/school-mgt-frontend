...
<script>
  ...
  import { categoryn5000Controller, accountn5000Controller } from '../../../store/modules/backendRoutes'
  ...
  import { get } from "../../../store/modules/services";
    ...
    return {
            Cycles:[],
            url: `${accountn5000Controller}/getcompletedlevelxcategories`,
            SelectedLevelUrl: "SelectedLevelN5000",
            Contribution: "5000",
            levelX: "",
            selected: null,
            columns: [
