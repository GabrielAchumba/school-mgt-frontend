...
export default {
    ...
    data(){
        return {
            title: "Import Grades",
            appVariables: [{variableTitle: "From", variableName: "from"},
            {variableTitle: "To", variableName: "to"},
            {variableTitle: "Point", variableName: "point"},
            {variableTitle: "Grade", variableName: "type"}],
            applicationColumns: [],
            dialogs: dialogs,
            tableRows: [],
        }
    ...
    created(){
        ...
        this.$store.commit("authenticationStore/setPageTitle", "Import Grades");  
    }
}
</script>
