...
export default {
    ...
    methods:{
        ...
        async save(){
            ...
            var url = `grade/${context.selectedGrade.id}`;
            const payload = {
                url,
                req: {
                    type: context.form.qInputs[0].name,
                    from: Number(context.form.qInputs[1].name),
                    to: Number(context.form.qInputs[2].name),
                    point: Number(context.form.qInputs[3].name),
    ...
    created(){
        var context =  this;
        context.selectedGrade = this.$store.getters["gradeStore/selectedGrade"];
        context.form.qInputs[0].name = context.selectedGrade.type;
