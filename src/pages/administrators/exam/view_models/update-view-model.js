...
const dialogs = [
    { title: "Update Examination Question", isVisible: false, message: "Do you want to update examination question",
    okayEvent: "okDialog", cancelEvent: "cancelDialog" },
    { title: "Success", isVisible: false, message: "Examination question updated successfully!",
    okayEvent: "okDialog", cancelEvent: "cancelDialog" },
