...
<div class="full-height full-width flex flex-center" style="background-color: rgba(0, 0, 0, 0.68) !important;">
            <div class="custom-caption">
              ...
              <div class="text-h4 animation_1">We are a community of vision oriented people striving for excellence.</div><br><br><br>
...
<div class="full-height full-width flex flex-center" style="background-color: rgba(0, 0, 0, 0.68) !important;">
            <div class="custom-caption">
              ...
              <div class="text-h4 animation_1">We must remain transparent, sincere and trustwothy,<br>one to another for the growth of the community</div><br><br><br>
            </div>
</div>
          </q-carousel-slide>
