const form = {
    ...
    qBtns: [
        ...
        {label: "Upload", name: "Create", icon: "add"},
    ],
    qDates: [],
    GroupedCheckBoxes: [],
    clearQInputs(){
...
const dialogs = [
    { title: "Upload File", isVisible: false, message: "Do you want to upload a File",
    okayEvent: "okDialog", cancelEvent: "cancelDialog" },
    { title: "Success", isVisible: false, message: "File uploaded successfully!",
    okayEvent: "okDialog", cancelEvent: "cancelDialog" },
