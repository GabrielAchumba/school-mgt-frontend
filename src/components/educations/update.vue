   ...
   computed: {
    ...
    return {
      ...
      methods: {
          ...
          this.$store.dispatch('educationStore/UpdateEducation', {
                startDay: sDay,
                startMonth: sMonth,
                startYear: sYear,
                endDay: eDay,
                ...
                level: context.level,
                id: context.SelectedEducation.id,
                userId: context.IdentityModel.id
                });
      ...
      cancel(){
        this.$store.commit('educationStore/CancelEducationDataUDialog');
      },
    ...
    created() {
        ...
        context.startDay = education.startDay;
        context.startMonth = education.startMonth;
        context.startYear = education.startYear;
        context.endDay = education.endDay;
        context.endMonth = education.endMonth;
        context.endYear = education.endYear;
        context.schoolName = education.schoolName;
        context.department = education.department;
        context.faculty = education.faculty;
        context.finalOverallGrade = education.finalOverallGrade;
        context.schoolCategory = education.schoolCategory;
        context.level = education.level;
        context.higherInstitution = education.higherInstitution
