<template>
    <div>
          ...
          <q-card-section class="bg-primary text-white">
            <div class="text-h6">Update Statement of Result</div>
          </q-card-section>
...
export default {
    computed: {
        ...
        SelectedStatementOfResult(){
            return this.$store.getters['statementOfResultsStore/SelectedStatementOfResult'];
        },
        SelectedEducation(){
    ...
    return {
      ...
      methods: {
          ...
          this.$store.dispatch('statementOfResultsStore/UpdateStatementOfResult', {
                level: context.level,
                ...
                id: context.SelectedStatementOfResult.id,
      ...
      cancel(){
        this.$store.commit('statementOfResultsStore/CancelStatementOfResultDataUDialog');
      }
    },
    created() {
        var context = this;
        var statementofresult = this.$store.getters['statementOfResultsStore/SelectedStatementOfResult'];
        context.level = statementofresult.level;
        context.subject = statementofresult.subject;
        context.grade=statementofresult.grade;
        context.obtainedDay=statementofresult.obtainedDay;
        context.obtainedMonth=statementofresult.obtainedMonth;
        context.obtainedYear=statementofresult.obtainedYear;
        context.grade=statementofresult.grade;
        context.score = statementofresult.score;
        context.examType = statementofresult.examType;
