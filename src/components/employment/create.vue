<template>
    <div>
          ...
          <q-card-section class="bg-primary text-white">
            <div class="text-h6">Register Employment</div>
          </q-card-section>
...
export default {
    ...
    return {
      ...
      cancel(){
        this.$store.commit('employmentStore/CancelEmploymentDataCDialog');
      }
    },
    created() {
        var context = this;
        var employment = this.$store.setters['employmentStore/NewEmployment']
