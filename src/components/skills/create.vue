<template>
    <div>
          ...
          <q-card-section class="bg-primary text-white">
            <div class="text-h6">Create Skill</div>
          </q-card-section>

          <q-card-section>
             <div class="row">
                    <div class="col-5">
                        <q-input v-model="title" label="Type of Skill"></q-input>
                    </div>
    ...
    return {
      ...
      methods: {
         getUrl (files) {
          ...
          this.$store.dispatch('skillStore/CreateSkill', {
      ...
      cancel(){
        this.$store.commit('skillStore/CancelSkillDataCDialog');
      }
    },
    created() {
