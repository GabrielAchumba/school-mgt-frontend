<template>
    <div>
          ...
          <q-card-section class="bg-primary text-white">
            <div class="text-h6">Register Referee</div>
          </q-card-section>
...
export default {
    ...
    return {
      ...
      methods: {
          ...
          this.$store.dispatch('referenceStore/CreateReference', {
      ...
      cancel(){
        this.$store.commit('referenceStore/CancelReferenceDataCDialog');
      }
    },
    created() {
        var context = this;
        var referee = this.$store.setters['referenceStore/NewReference']
